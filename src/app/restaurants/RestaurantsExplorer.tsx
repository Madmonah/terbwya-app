    ...
    <div>
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 mb-3">
        <button
          ...
          className={`whitespace-nowrap px-4 py-2 rounded-full font-bold text-sm transition-all ${
            !cuisineSlug
              ? 'bg-gradient-to-br from-sunset-400 to-violet-600 text-white shadow-sm'
      ...
      <div className="flex items-center justify-between gap-3 mb-6 flex-wrap">
        ...
        >
          ...
          فلاتر
          {activeFilterCount > 0 && (
            <span className="bg-gradient-to-br from-sunset-400 to-violet-600 text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px]">
              {activeFilterCount}
            </span>
          )}
        </button>
